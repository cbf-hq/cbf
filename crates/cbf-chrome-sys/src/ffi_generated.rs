...
pub const CBF_EVENT_NEW_TAB_REQUESTED: u8 = 8;
pub const CBF_EVENT_BEFOREUNLOAD_DIALOG_REQUESTED: u8 = 9;
pub const CBF_EVENT_TAB_CLOSED: u8 = 10;
pub const CBF_EVENT_NAVIGATION_STATE_CHANGED: u8 = 11;
pub const CBF_EVENT_TAB_RESIZE_ACKNOWLEDGED: u8 = 12;
pub const CBF_EVENT_CURSOR_CHANGED: u8 = 13;
pub const CBF_EVENT_TAB_DOM_HTML_READ: u8 = 14;
...
pub const CBF_EVENT_PROMPT_UI_OPENED: u8 = 23;
pub const CBF_EVENT_PROMPT_UI_CLOSED: u8 = 24;
...
pub const CBF_BEFOREUNLOAD_REASON_CLOSE_TAB: u8 = 1;
