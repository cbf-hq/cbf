...
pub(crate) const TEST_POPUP_CREATE_REQUEST_ID: u64 = 4;
...
pub(crate) struct SharedState {
    ...
    pub(crate) test_popup_browsing_context_id: Option<BrowsingContextId>,
...
impl Default for SharedState {
    fn default() -> Self {
        Self {
            ...
            test_popup_browsing_context_id: None,
...
pub(crate) fn set_test_popup_browsing_context_id(
    shared: &SharedStateHandle,
    browsing_context_id: Option<BrowsingContextId>,
) {
    shared
        .lock()
        .expect("shared state lock poisoned")
        .test_popup_browsing_context_id = browsing_context_id;
}

pub(crate) fn test_popup_browsing_context_id(
    shared: &SharedStateHandle,
) -> Option<BrowsingContextId> {
    shared
        .lock()
        .expect("shared state lock poisoned")
        .test_popup_browsing_context_id
}
