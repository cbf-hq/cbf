...
| 2026-03 compositor alpha.2 | planned | 2026-03-30 | not released | not released | not released | not released | 0.1.0-alpha.2 | 146.0.7680.153 | `cbf-chrome-runtime-v146.0.0-alpha.2+chromium-146.0.7680.153-r1` | Standalone `cbf-compositor` update against the existing alpha.2 runtime bundle |
| 2026-03 compositor alpha.3 | planned | 2026-03-31 | not released | not released | not released | not released | 0.1.0-alpha.3 | 146.0.7680.153 | `cbf-chrome-runtime-v146.0.0-alpha.2+chromium-146.0.7680.153-r1` | Standalone `cbf-compositor` update against the existing alpha.2 runtime bundle |
