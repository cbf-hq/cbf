...
| 2026-04 alpha.5 | released | 2026-04-09 | 0.1.0-alpha.4 | 0.1.0-alpha.5 | 146.1.0-alpha.4 | 0.1.0-alpha.2 | 0.1.0-alpha.7 | 146.0.7680.153 | `cbf-chrome-runtime-v146.0.0-alpha.4+chromium-146.0.7680.153-r1` / `bf-chrome-runtime-v146.0.0-alpha.5+chromium-146.0.7680.153-r1` | `cbf-compositor` is a compatibility-only dependency update |
